...
package com.transfinder.mobile.android.mockgpsagent.location;
...
public class LocationBuilder {
    ...
    public static final String LONGITUDE_PARAMETER_KEY = "longitude";
    public static final String LATITUDE_PARAMETER_KEY = "latitude";
    public static final String ALTITUDE_PARAMETER_KEY = "altitude";
    public static final String SPEED_PARAMETER_KEY = "speed";
    public static final String BEARING_PARAMETER_KEY = "bearing";
